/**
 * O estado "Telegram" da superficie de UI nativa do DSH — OFFLINE/ONLINE —
 * e as instrucoes que o clique mostra.
 *
...
export type MotivoDoTelegram = 'sem-chave' | 'sem-pareamento'
...
export type TelegramEstado =
  ...
  | { readonly online: false; readonly motivo: MotivoDoTelegram }

export interface DerivarTelegramInput {
 ...
 */
export function derivarEstadoTelegram(input: DerivarTelegramInput): TelegramEstado {
 ...
 */
export function passosDoTelegram(estado: TelegramEstado): ReadonlyArray<Passo> {
