 ...
 * controlo.
 *
 * ONDA 5a: este ficheiro testa o MASCARAMENTO NEUTRO que permanece
 * (`worker/lib/redact.ts` nao e legado — o `log.ts` neutro importa-o). Vivia em
 * `test/unit/worker/lib/` (diretoria de testes orfaos apagada); foi RE-HOMED para
 * `test/unit/worker/lib-infra/`.
 */
...
import { TOKEN_DE_TESTE } from '../bot-apoio.ts'
