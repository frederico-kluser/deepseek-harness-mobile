/**
 * Bancada partilhada do BOOT generico e do worker (onda 5a): antes vivia em
 * `test/unit/worker/lib/apoio.ts` (a diretoria de Testes Legionarios foi apagada;
 * esta bancada NAO e um teste orfao — e o apoio vivo de `telegram-bot.test.ts`).
 *
