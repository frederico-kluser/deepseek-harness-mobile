...
/* ========================================================================== */
/* Rotulos provider-aware (Onda 2 do host): @BotFather                        */
/* ========================================================================== */

describe('textos provider-aware (rotulos por provedor)', () => {
  it('os titulos telegram continuam intactos', () => {
  ...
  it('sem `provedor`, o texto e o do telegram (default fechado telegram, D1)', () => {
    const texto = textoSemToken({ caminhoSecretsEnv: CAMINHO_APRESENTAVEL })
