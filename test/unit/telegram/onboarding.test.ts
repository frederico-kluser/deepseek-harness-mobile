...
describe('a forma do token por provedor (Onda 2 do host)', () => {
  it('validarFormatoDe delega no provedor: telegram usa a forma estrita', () => {
    // A porta usada pelo painel: o que o telegram recusa em forma continua
    // recusado.
