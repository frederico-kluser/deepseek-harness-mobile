...
export declare const STATE_DIR_SEGMENT = "guarded-bot";
...
export declare const STATE_DIR_MODE = 448;
/** Ficheiro: so o dono le e escreve. */
export declare const STATE_FILE_MODE = 384;
/**
 ...
 * `0600` e `0400` -> passam.
 */
export declare const EXPOSURE_MASK = 63;
 ...
 */
export declare function resolveDshHome(options?: ResolveStatePathsOptions): string;
/** Os caminhos de um diretorio de estado JA escolhido (e o que os testes injetam). */
export declare function statePathsAt(dir: string): StatePaths;
/** O caminho canonico: `<raiz do harness>/guarded-bot/state.json`. */
export declare function resolveStatePaths(options?: ResolveStatePathsOptions): StatePaths;
/**
 ...
 */
export declare function ensureStateDir(paths: StatePaths): void;
/**
 ...
 */
export declare function assertOwnedByUs(uid: number, path: string): void;
