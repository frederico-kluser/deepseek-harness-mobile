 ...
 */
export function buildControlIntent(input) {
    return {
        action: input.action,
 ...
 */
export function exigeNonce(action) {
 ...
 */
export const RECUSA_MOTIVO = Object.freeze({
...
export function motivoDaRecusa(recusa) {
 ...
 */
export const RECUSA_SEM_ROTULO = [];
/**
 ...
 */
export function projectResultado(resultado) {
    return {
