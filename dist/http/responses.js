 ...
 */
export function denyUntrustedOrigin(res) {
    res.writeHead(403, {
 ...
 */
export const TEXT_REFUSAL_HEADERS = Object.freeze({
    'content-type': 'text/plain; charset=utf-8',
    'cache-control': 'no-store',
    // Ver a REGRA DE FICHEIRO no cabecalho.
    'referrer-policy': 'no-referrer',
 ...
 */
export function denyNotFound(res) {
 ...
 */
export function denyUpgrade(socket, status) {
