 ...
 */
export declare function denyUntrustedOrigin(res: ServerResponse): void;
/**
 ...
 */
export declare const TEXT_REFUSAL_HEADERS: Readonly<Record<string, string>>;
/** O corpo do 404. Generico de proposito -- ver {@link denyNotFound}. */
export declare const NOT_FOUND_BODY = "Not Found\n";
/**
 ...
 */
export declare function denyNotFound(res: ServerResponse): void;
/**
 ...
 */
export declare function denyUnauthorized(res: ServerResponse): void;
/**
 ...
 */
export declare function denyUpgrade(socket: Duplex, status: 401 | 403): void;
