 ...
 */
export function canonicalRequestPath(rawUrl) {
 ...
 */
export function isGuardedPath(rawUrl, guardedPrefixes) {
    ...
    return guardedPrefixes.some((rawPrefix) => {
        ...
        if (prefix === '/')
            return true; // prefixo `/` cobre o servidor inteiro
 ...
 */
export function routeMayServeGuardedPath(route, guardedPrefixes) {
