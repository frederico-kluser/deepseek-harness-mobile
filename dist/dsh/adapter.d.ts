...
import type { HarnessAgentRegistry, HarnessSkillRegistry, HarnessSubagentRuntime } from '../agents/harness.ts';
export type { Context, Disposable, SubprocessHandle, SubprocessOutcome, SubprocessSpawnSpec, WebRoute, WebServer, WebUpgradeRoute, };
/**
 ...
 */
export declare function resolveWebServerHttpServer(webServer: WebServer | undefined | null): Server;
