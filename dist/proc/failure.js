 ...
 */
export function spawnErrno(error) {
 ...
 * primeiro.
 */
export function classifyNonRetryable(error) {
    if (error instanceof SpawnSpecError)
        return 'INVALID_SPEC';
 ...
 */
export function describeNonRetryable(kind, name) {
    switch (kind) {
