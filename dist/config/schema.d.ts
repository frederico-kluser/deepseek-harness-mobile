...
export declare function resolvePackagedWorkerDir(moduleUrl: string): string;
/**
 ...
 */
export declare function resolveWorkerEntrypoint(moduleUrl: string): string;
/** Diretorio `worker/` empacotado desta instalacao. */
export declare const PACKAGED_WORKER_DIR: string;
/** Entrypoint do worker desta instalacao, para o `argv` do spawn. */
export declare const PACKAGED_WORKER_ENTRYPOINT: string;
/**
 ...
 */
export declare function resolveWorkerCwd(config: Config): string;
/**
 ...
 */
export declare const LOOPBACK_ONLY_EXPOSURE: ExposureConfig;
/** O eixo `exposure` efetivo. Ver {@link LOOPBACK_ONLY_EXPOSURE}. */
export declare function resolveExposure(config: Config): ExposureConfig;
/** A leitura de `control` ausente: a confirmacao de duas etapas fica LIGADA. */
export declare const CONFIRMATION_REQUIRED_CONTROL: ControlConfig;
/** O eixo `control` efetivo. */
export declare function resolveControl(config: Config): ControlConfig;
/**
 ...
 */
export declare const AGENTS_FAIL_CLOSED: AgentsConfig;
/** O eixo `agents` efetivo. Ver {@link AGENTS_FAIL_CLOSED}. */
export declare function resolveAgents(config: Config): AgentsConfig;
/**
 ...
 */
export declare function shouldAutoStartTunnel(config: Config, restrictedModeActive: boolean): boolean;
/**
 ...
 */
export declare function mayTrustEdgeClientIp(exposure: ExposureConfig, viaTunnel: boolean): boolean;
