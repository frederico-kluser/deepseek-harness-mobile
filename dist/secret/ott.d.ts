 ...
 */
/** 16 bytes = 128 bits. */
export declare const OTT_BYTES = 16;
/** 10 minutos. */
export declare const OTT_TTL_MS: number;
/**
...
export declare function createOneTimeTokenStore(deps: OneTimeTokenDeps): OneTimeTokenStore;
