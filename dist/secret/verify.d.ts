 ...
 */
import { type SecretDigest } from '../brand.ts';
/** SHA-256: 32 bytes. E este numero fixo que torna a comparacao total. */
export declare const SECRET_DIGEST_BYTES = 32;
/** Erro de digest malformado. Fail loud: um digest invalido nao vira "sem segredo". */
export declare class SecretDigestError extends Error {
    readonly name = "SecretDigestError";
}
/** Digest hexadecimal do segredo, na forma que `PersistedState.secretDigest` guarda. */
export declare function digestSecret(secret: string): SecretDigest;
/**
 ...
 */
export declare function verifySecret(candidate: string, expected: SecretDigest | undefined): boolean;
