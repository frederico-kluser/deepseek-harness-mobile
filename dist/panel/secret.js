 ...
 */
import { NOT_FOUND_RESPONSE } from "./api.js";
import { renderSecretPanel } from "../secret/generate.js";
import { newNonce, panelHtmlHeaders, renderSecretPage } from "./html.js";
...
export function createSecretHandler(deps) {
    return async (exchange) => {
        ...
        if (secret === null) {
            ...
            deps.log.warn('[painel] ott valido consumido sem segredo em memoria para mostrar; ' +
