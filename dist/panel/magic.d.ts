...
import type { AuditGate, PanelHandler } from './api.ts';
/** Nome do campo que transporta o `mk` no corpo do `POST`. */
export declare const MAGIC_FIELD_NAME = "mk";
/**
 ...
 */
export declare const MAGIC_CRAWLER_EVENT = "magic.crawler-suspect";
/**
 ...
 */
export declare const CLICK_SIGNAL_HEADER = "sec-fetch-site";
 ...
 * cookie duplicado.
 */
export declare function classifyClickSignal(req: IncomingMessage): ClickSignal;
 ...
 */
export declare function createMagicPageHandler(bindings: MagicPageBindings): PanelHandler;
 ...
 */
export declare function createMagicConsumeHandler(deps: MagicConsumeDeps): PanelHandler;
