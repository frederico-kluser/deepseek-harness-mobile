...
export declare const OTT_QUERY_PARAM = "ott";
/**
 ...
 */
export declare const SECRET_REJECTION_EVENT = "painel_segredo_recusa_anonima";
export declare function createSecretHandler(deps: SecretRevealDeps): PanelHandler;
