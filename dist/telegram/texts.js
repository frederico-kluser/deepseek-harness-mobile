 ...
 * explicito (PAIR-010).
 */
import { COMANDO_DE_PAREAMENTO, DIGITOS_DO_CODIGO } from "./pairing.js";
...
function nomeDoCanal(_provedor) {
    return 'Telegram';
}
/**
 ...
 */
export function tituloSemToken(_provedor = 'telegram') {
    return TITULO_SEM_TOKEN;
}
/** Titulo do estado TOKEN_INVALIDO, por provedor. Ver {@link tituloSemToken}. */
export function tituloTokenInvalido(_provedor = 'telegram') {
 ...
 */
export function textoSemToken(opcoes) {
 ...
 */
export function textoTokenInvalido(retrato, opcoes = {}) {
 ...
 */
function diagnostico(retrato, canal) {
...
function explicarFormato(motivo) {
    switch (motivo) {
        case 'vazio':
 ...
 */
export function textoSemDono(bot, opcoes) {
 ...
 */
export function textoPronto(bot, opcoes) {
    return `  bot     ${bot}
  dono    pareado
