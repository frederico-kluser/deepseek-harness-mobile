 ...
 */
export function assertRateLimitPolicy(policy) {
    ...
    if (policy.bruteForceCeiling > NIST_BRUTE_FORCE_CEILING) {
        throw new RateLimitPolicyError(`bruteForceCeiling ${String(policy.bruteForceCeiling)} excede o teto normativo de ${String(NIST_BRUTE_FORCE_CEILING)} ` +
 ...
 */
export function computeAuthDelayMs(consecutiveFailures, policy, random) {
 ...
 */
export function banAppliesToScope(scope) {
    return scope !== 'global';
}
 ...
 */
export function resolveIdentityBucket(identity) {
 ...
 */
export function isBanTriggeredBy(consecutiveFailures, policy) {
 ...
 */
export function hasReachedBruteForceCeiling(consecutiveAccountFailures, policy) {
