 ...
 */
export declare const NIST_BRUTE_FORCE_CEILING = 100;
...
export declare class RateLimitPolicyError extends Error {
 ...
 */
export declare function assertRateLimitPolicy(policy: RateLimitPolicy): void;
/**
 ...
 */
export declare function computeAuthDelayMs(consecutiveFailures: number, policy: RateLimitPolicy, random: () => number): number;
/**
 ...
 */
export declare function banAppliesToScope(scope: IdentityScope): boolean;
...
export declare const GLOBAL_BUCKET_KEY = "global";
/**
 ...
 */
export declare function resolveIdentityBucket(identity: Identity): IdentityBucket;
/**
 ...
 */
export declare function isBanTriggeredBy(consecutiveFailures: number, policy: RateLimitPolicy): boolean;
/**
 ...
 */
export declare function hasReachedBruteForceCeiling(consecutiveAccountFailures: number, policy: RateLimitPolicy): boolean;
