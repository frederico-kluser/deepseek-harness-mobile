...
import { gerarRequestId } from "../surface/tokens.js";
import { createTelegramProvider } from "./telegram/adapter.js";
import { API_ROOT_ENV_VAR as TELEGRAM_API_ROOT_ENV_VAR, assertTokenNotInArgv, lerTokenDoAmbiente, } from "./telegram/token.js";
/* ========================================================================== */
...
export const DEFAULT_PROVIDER_ID = 'telegram';
/**
...
export class ProvedorDesconhecidoError extends Error {
    name = 'ProvedorDesconhecidoError';
    id;
    constructor(id) {
        super(`[worker/providers] provedor desconhecido: "${id}". Os antecipados sao: ` +
 ...
 */
export function montarEnvelopeDeIntent(pedido) {
    return {
 ...
 */
export function criarSurfaceIpcBridge(ipc) {
    return {
        send: (pedido) => ipc.send(montarEnvelopeDeIntent(pedido)),
        /**
