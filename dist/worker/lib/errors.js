...
export function isWorkerExitCode(code) {
    return (code === WORKER_EXIT.CONFIG ||
 ...
 * e o contrato que QUALQUER adaptador e o boot partilham:
 *
...
export class ProviderError extends Error {
    ...
    reason;
    constructor(code, reason, detail, options) {
