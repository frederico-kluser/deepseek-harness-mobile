 ...
 */
export function maskAuditText(text, knownSecrets = []) {
...
export function toAuditRecord(event, tsMs, knownSecrets = []) {
    ...
    const resultado = event.resultado;
    if (resultado !== 'permitido' && resultado !== 'negado') {
         ...
         */
        throw new AuditFormatError(`resultado invalido: ${JSON.stringify(resultado)} (esperado 'permitido' ou 'negado')`);
    }
    /*
