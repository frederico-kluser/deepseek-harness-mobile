 ...
 */
export type TunnelState = 'STOPPED' | 'STARTING' | 'READY' | 'DEGRADED' | 'STOPPING' | 'FAILED';
/**
 ...
 */
export type ProbeId = 'spa-fallback' | 'api-rpc' | 'websocket-upgrade' | 'unguarded-canary';
 ...
 */
export type TunnelFailureCode = 'PROBE_FAILED' | 'BINARY_NOT_FOUND' | 'BINARY_NOT_EXECUTABLE' | 'INVALID_CONFIG' | 'READINESS_TIMEOUT' | 'PROCESS_EXITED' | 'BUDGET_EXHAUSTED' | 'TTL_EXPIRED';
/**
