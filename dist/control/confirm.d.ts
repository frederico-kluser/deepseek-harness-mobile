 ...
 */
import type { ConfirmService, ControlAction } from '../contracts/control.ts';
 ...
 */
export declare const MAX_LIVE_NONCES = 1024;
export declare function createConfirmService(deps: ConfirmServiceDeps): ConfirmServiceComVeredito;
